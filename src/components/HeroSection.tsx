        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="text-gradient"> Engaging Videos</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" className="group" onClick={handleStartCreating}>
                Start Creating
              ...
              <div className="glass-card rounded-3xl p-8 relative">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="p-6 rounded-xl bg-white/50 backdrop-blur-sm">
